...
![Convergence plot: best-so-far minimum clues vs. iteration for the 4×4 Sudoku search](https://res.cloudinary.com/dwp6mzleh/image/upload/q_auto/f_auto/v1779742224/01_minimum_clues_found_vs_iteration_4x4_znglj0.png "Convergence of the greedy-removal heuristic on the 4×4 grid: best-so-far minimum clues vs. iteration.")
...
![Convergence plot: best-so-far minimum clues vs. iteration for the 9×9 Sudoku search](https://res.cloudinary.com/dwp6mzleh/image/upload/q_auto/f_auto/v1779742224/02_minimum_clues_found_vs_iteration_9x9_yjvudt.png "Convergence of the greedy-removal heuristic on the 9×9 grid: best-so-far minimum clues vs. iteration.")
...
![Convergence plot: best-so-far minimum clues vs. iteration for the 16×16 Sudoku search](https://res.cloudinary.com/dwp6mzleh/image/upload/q_auto/f_auto/v1779742224/03_minimum_clues_found_vs_iteration_16x16_wmjr1w.png "Convergence of the greedy-removal heuristic on the 16×16 grid: best-so-far minimum clues vs. iteration.")
