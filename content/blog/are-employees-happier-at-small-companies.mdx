...
![Mean rating by company size bucket](https://res.cloudinary.com/dwp6mzleh/image/upload/q_auto/f_auto/v1779742784/02_average_employee_rating_by_company_size_nkipx0.png "Mean rating by company size bucket")
...
That's a weak but statistically significant negative correlation. As companies get bigger, ratings tend to go down — just not by much. An ordinal logistic regression tells the same story: for every 10× increase in review count, a firm's odds of being in a higher rating category drop by about 1.3×. The scatter plot with a LOWESS trend line makes this visible:

![Scatter plot with LOWESS trend](https://res.cloudinary.com/dwp6mzleh/image/upload/q_auto/f_auto/v1779742787/06_firm_ratings_vs_company_size_fej4gn.png "Scatter plot with LOWESS trend")

You can see the cloud of points compressing as firms get larger (regression to the mean; more reviews = less noise), and the magenta LOWESS line gently slopes downward.
...
![Summary dashboard](https://res.cloudinary.com/dwp6mzleh/image/upload/q_auto/f_auto/v1779742788/08_summary_dashboard_zkffu9.png "Summary dashboard")
...
*The full analysis notebook (with all statistical tests, 8 figures, and robustness checks) is available as a [Colab notebook](https://colab.research.google.com/drive/18RCthpnv_WUNFgSzibUs_A6fMKFoLkMl?usp=sharing). Data source: [Glassdoor Job Reviews dataset](https://www.kaggle.com/datasets/davidgauthier/glassdoor-job-reviews-2) on Kaggle.*
